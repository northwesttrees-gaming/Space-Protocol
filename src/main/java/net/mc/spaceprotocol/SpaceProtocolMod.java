...
@Mod("space_protocol")
public class SpaceProtocolMod {
	public static final Logger LOGGER = LogManager.getLogger(SpaceProtocolMod.class);
	public static final String MODID = "space_protocol";

	public SpaceProtocolMod(IEventBus modEventBus) {
