...
import net.mc.spaceprotocol.procedures.VerticalAlienWallTooltipProcedure;
import net.mc.spaceprotocol.init.SpaceProtocolModBlocks;
import net.mc.spaceprotocol.SpaceProtocolMod;

import java.util.function.Consumer;

public class VerticalAlienWallBlock extends WallBlock {
	public VerticalAlienWallBlock(BlockBehaviour.Properties properties) {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.VERTICAL_ALIEN_WALL.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = VerticalAlienWallTooltipProcedure.execute();
			if (hoverText != null) {
