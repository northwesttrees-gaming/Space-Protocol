...
public class AlienShipSlabBlock extends SlabBlock {
	public AlienShipSlabBlock(BlockBehaviour.Properties properties) {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_SHIP_SLAB.get(), properties);
		}
