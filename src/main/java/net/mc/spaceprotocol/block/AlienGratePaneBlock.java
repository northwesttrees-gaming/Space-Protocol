...
import net.mc.spaceprotocol.procedures.AlienGratePaneTooltipProcedure;
...
public class AlienGratePaneBlock extends IronBarsBlock {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_GRATE_PANE.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = AlienGratePaneTooltipProcedure.execute();
			if (hoverText != null) {
