...
public class AlienShipHorizontalWallBlock extends WallBlock {
	public AlienShipHorizontalWallBlock(BlockBehaviour.Properties properties) {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_WALL.get(), properties);
		}
