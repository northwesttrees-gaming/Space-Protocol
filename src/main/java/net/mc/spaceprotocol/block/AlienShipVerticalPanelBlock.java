...
public class AlienShipVerticalPanelBlock extends Block {
	public AlienShipVerticalPanelBlock(BlockBehaviour.Properties properties) {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_SHIP_VERTICAL_PANEL.get(), properties);
		}
