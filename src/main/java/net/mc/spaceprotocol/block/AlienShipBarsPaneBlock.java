...
public class AlienShipBarsPaneBlock extends IronBarsBlock {
	public AlienShipBarsPaneBlock(BlockBehaviour.Properties properties) {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_SHIP_BARS_PANE.get(), properties);
		}
