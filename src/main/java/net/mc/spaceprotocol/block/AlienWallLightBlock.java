...
import net.mc.spaceprotocol.procedures.AlienWallLightTooltipProcedure;
...
public class AlienWallLightBlock extends Block {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_WALL_LIGHT.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = AlienWallLightTooltipProcedure.execute();
			if (hoverText != null) {
