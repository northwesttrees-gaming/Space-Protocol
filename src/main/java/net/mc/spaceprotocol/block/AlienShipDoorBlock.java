...
import net.mc.spaceprotocol.procedures.AlienShipDoorTooltipProcedure;
import net.mc.spaceprotocol.init.SpaceProtocolModBlocks;
import net.mc.spaceprotocol.SpaceProtocolMod;

import java.util.function.Consumer;

public class AlienShipDoorBlock extends DoorBlock {
	public AlienShipDoorBlock(BlockBehaviour.Properties properties) {
	...
	public static class Item extends DoubleHighBlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_SHIP_DOOR.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = AlienShipDoorTooltipProcedure.execute();
			if (hoverText != null) {
