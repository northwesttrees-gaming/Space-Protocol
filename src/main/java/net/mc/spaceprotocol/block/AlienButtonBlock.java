...
import net.mc.spaceprotocol.procedures.AlienButtonTooltipProcedure;
...
public class AlienButtonBlock extends ButtonBlock {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_BUTTON.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = AlienButtonTooltipProcedure.execute();
			if (hoverText != null) {
