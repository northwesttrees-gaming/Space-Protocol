...
public class AlienShipHorizontalPanelBlock extends Block {
	public AlienShipHorizontalPanelBlock(BlockBehaviour.Properties properties) {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_PANEL.get(), properties);
		}
