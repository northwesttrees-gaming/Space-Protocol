...
import net.mc.spaceprotocol.procedures.AlienDoorTooltipProcedure;
...
public class AlienDoorBlock extends DoorBlock {
	...
	public static class Item extends DoubleHighBlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_DOOR.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = AlienDoorTooltipProcedure.execute();
			if (hoverText != null) {
