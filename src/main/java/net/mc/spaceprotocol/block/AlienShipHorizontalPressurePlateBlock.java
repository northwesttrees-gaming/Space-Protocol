...
import net.mc.spaceprotocol.procedures.AlienShipHorizontalPressurePlateTooltipProcedure;
import net.mc.spaceprotocol.init.SpaceProtocolModBlocks;
import net.mc.spaceprotocol.SpaceProtocolMod;

import java.util.function.Consumer;

public class AlienShipHorizontalPressurePlateBlock extends PressurePlateBlock {
	public AlienShipHorizontalPressurePlateBlock(BlockBehaviour.Properties properties) {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_PRESSURE_PLATE.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = AlienShipHorizontalPressurePlateTooltipProcedure.execute();
			if (hoverText != null) {
