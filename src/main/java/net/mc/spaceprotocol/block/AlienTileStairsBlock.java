...
import net.mc.spaceprotocol.procedures.AlienTileStairsTooltipProcedure;
...
public class AlienTileStairsBlock extends StairBlock {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_TILE_STAIRS.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = AlienTileStairsTooltipProcedure.execute();
			if (hoverText != null) {
