...
import net.mc.spaceprotocol.procedures.HorizontalAlienWallTooltipProcedure;
...
public class HorizontalAlienWallBlock extends WallBlock {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.HORIZONTAL_ALIEN_WALL.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = HorizontalAlienWallTooltipProcedure.execute();
			if (hoverText != null) {
