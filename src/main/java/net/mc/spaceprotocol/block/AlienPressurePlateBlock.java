...
import net.mc.spaceprotocol.procedures.AlienPressurePlateTooltipProcedure;
...
public class AlienPressurePlateBlock extends PressurePlateBlock {
	...
	public static class Item extends BlockItem {
		public Item(Item.Properties properties) {
			super(SpaceProtocolModBlocks.ALIEN_PRESSURE_PLATE.get(), properties);
		}
		...
		public void appendHoverText(ItemStack itemstack, Item.TooltipContext context, TooltipDisplay tooltipDisplay, Consumer<Component> componentConsumer, TooltipFlag flag) {
			...
			String hoverText = AlienPressurePlateTooltipProcedure.execute();
			if (hoverText != null) {
