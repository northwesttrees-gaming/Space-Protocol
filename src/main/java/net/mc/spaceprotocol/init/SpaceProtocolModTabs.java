...
public class SpaceProtocolModTabs {
	...
	public static final DeferredHolder<CreativeModeTab, CreativeModeTab> SPACE_PROTOCOL_BLOCKS = REGISTRY.register("space_protocol_blocks",
			() -> CreativeModeTab.builder().title(Component.translatable("item_group.space_protocol.space_protocol_blocks")).icon(() -> new ItemStack(SpaceProtocolModBlocks.ALIEN_SHIP_BLOCK.get())).displayItems((parameters, tabData) -> {
				...
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_STAIRS.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_SLAB.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_WALL.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_PRESSURE_PLATE.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_BUTTON.get().asItem());
				...
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_STAIRS.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_SLAB.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_WALL.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_PRESSURE_PLATE.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_BUTTON.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_VERTICAL_PANEL.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_VERTICAL_STAIRS.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_VERTICAL_SLAB.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_VERTICAL_WALL.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_VERTICAL_PRESSURE_PLATE.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_VERTICAL_BUTTON.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_TILES.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_TILE_STAIRS.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_TILE_SLAB.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_TILE_WALL.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_TILE_PRESSURE_PLATE.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_TILE_BUTTON.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_GRATE.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_GRATE_PANE.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_BARS.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_BARS_PANE.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_GLASS.get().asItem());
				tabData.accept(SpaceProtocolModBlocks.ALIEN_SHIP_GLASS_PANE.get().asItem());
