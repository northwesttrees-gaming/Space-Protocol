...
public class SpaceProtocolModItems {
	...
	static {
		...
		ALIEN_SHIP_WALL = block(SpaceProtocolModBlocks.ALIEN_SHIP_WALL);
		ALIEN_SHIP_TILE_PRESSURE_PLATE = block(SpaceProtocolModBlocks.ALIEN_SHIP_TILE_PRESSURE_PLATE);
		ALIEN_SHIP_HORIZONTAL_SLAB = block(SpaceProtocolModBlocks.ALIEN_SHIP_HORIZONTAL_SLAB);
		ALIEN_SHIP_GLASS = block(SpaceProtocolModBlocks.ALIEN_SHIP_GLASS);
